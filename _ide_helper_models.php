 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Book highestRated6LastMonths()
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|Book title(string $title)
