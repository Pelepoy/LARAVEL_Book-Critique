...
<body class="pt-16 mx-auto container">
    <x-success />
    <x-navbar />
    @yield('content')
    <div class="fixed bottom-0 left-0 right-0 bg-blue-500 text-white text-center py-3">
      Care to publish and rate your book? <a href="" class="underline">Register</a> or <a href="" class="underline">Login</a> now!
  </div>
</body>
